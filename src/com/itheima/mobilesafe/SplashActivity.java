		...
		if(getVersion().equals(updateInfo.getVersion())){//版本相同,无需升级,进入主界面
			...
			builder.setPositiveButton("立即升级", new OnClickListener() {
				...
				public void onClick(DialogInterface arg0, int arg1) {
					...
					finalHttp.download(updateInfo.getApkurl(), file.getAbsolutePath(), new AjaxCallBack<File>() {
						/**
						 * count文件总长度
						 * current当前进度
						 */
						...
						public void onSuccess(File t) {
							super.onSuccess(t);
							Toast.makeText(getApplicationContext(), "下载更新文件成功,准备安装...",Toast.LENGTH_LONG).show();
							intallApk(t);
						}
						...
						public void onFailure(Throwable t, int errorNo,
							...
							t.printStackTrace();
							Toast.makeText(getApplicationContext(), "下载更新文件失败",Toast.LENGTH_LONG).show();
						}
					});
